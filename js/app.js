(() => {
    ...
    gsap.from(".catch-glimse__right", {
        start: "top bottom",
        end: "center center",
        scrollTrigger: ".catch-glimse__right",
        duration: 1,
        scale: .8,
        opacity: 0,
        ease: "back.out(1.7)",
    ...
    gsap.from(".header-project__count", {
        scrollTrigger: {
            trigger: ".header-project__count",
            start: "top center"
        },
        duration: 1.2,
        x: -50,
    ...
    gsap.from(".location-footer", {
        scrollTrigger: {
            trigger: ".footer__location",
            start: "top bottom"
        },
        duration: 1,
        x: -30,
